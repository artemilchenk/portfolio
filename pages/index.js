                ...
                <div id='aboutMe'
                    ...
                    <div className={'col-span-4 md:col-span-3 mr-5'}>
                        ...
                        <div className={'text-left text-sm md:text-lg border-b-2 border-red-700 font-serif mb-5 pb-5'}>
                            ...
                            головним направлення була економіка до якої я проявляв нуль цікавості і впринципі закінчив
                            ...
                            геометріі) я думав про Політєх. <p>І от, набраши на незалежному тестуванні 177 балів по
                            ...
                            практично не було, загруженість божевільна, ми пахали зранку до ночі, і тоді, я зрозумів, що
                            ...
                            5
                            років в нікуди, просто 5 років тусовки. І відповідно, так як мені було "ціково" так же я і
                            ...
                            горіли очі від того чим я замаюсь щоб робота перетворилась в пристрасть і тоді я не буду
                            "працювати" ні одного дня в саоєму житті.<p>Я пам'ятаю зима 2020 - час коли я
                            ...
                            не вірити в себе, що ти не зможеш, що ти не достатньо розумний для цього, докажи собі, що ти
                            помилявся і шо ці роки не віри в себе це тільки роки, ти ще з дитинства хотів і мріяв про
                            це, доведи що це все було не мароно! Так, мені не вистачало наставника, який розжуе до
                            атомів та покладе в рот, і тому це все приходилось робити самому витрачаючи на це набагато
                            більше часу, хоча я вже багато чого пізнав в цій професії, але я ще досі не профсіонал і ще
                            багато чого не знаю, але я кожного дня пізнаю щось нове та вдосконалююсь.Я впевнений, що
                            хочу присвятити
                            цьому залишок свого життя.</p> У вашій компанії я мрію знайти людей-колег-однодумців з якими
                            я
                            буду обмінюватись доствідом, робити щось спільне, створювати нові продукти, придуиувати щось
